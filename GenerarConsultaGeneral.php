<?php
	...
	require("pdf.php");
			...
			$consulta = "select carnet, nombre, apellido, direccion, telefono, id_estado, (case when id_estado = 1 then 'activo' when id_estado = 0 then 'inactivo' END) AS id_estado from alumnos.alumnos";
