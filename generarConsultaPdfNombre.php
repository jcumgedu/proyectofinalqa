<?php
	...
	if(isset($_POST['consultar'])){
		if(strlen($_POST['nombre']) > 1){
			...
			$consulta = "select carnet, nombre, apellido, direccion, telefono, id_estado, (case when id_estado = 1 then 'activo' when id_estado = 0 then 'inactivo' END) AS id_estado from alumnos.alumnos where nombre LIKE '$nombre'";
			...
			echo'<script type="text/javascript">
	                ...
	                window.location.href="ConsultaAlumnosNombre.php";
	                </script>';
		}
	}
?>